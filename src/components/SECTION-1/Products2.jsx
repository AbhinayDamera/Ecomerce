...
const Products2 = ({ cart, setCart, count, setCount }) => {
    ...
    <div>
      ...
      <div className="px-4 md:px-10 mt-10">
        <div className="text-xl md:text-3xl text-gray-600 font-medium">
          ...
          <span className="text-blue-500">Laptops</span>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 px-4 md:px-10 mt-5">
        ...
        {products2.map((product) => (
          <div
            key={product.id}
            className="border rounded-xl p-4 flex flex-col items-center border-gray-300 hover:shadow-2xl hover:shadow-blue-500 transition-all duration-300"
          >
